...
###################################################################
'''
     No longer coding will cause problems
'''
###################################################################
#                             COLOR
...
try:
	...
	print '(_oo_)'.center(44)
	print '(O)'.center(44)
	print (c4 +'__||__    \)').center(44)
	print ('[]/______\[] /').center(44)
	print ('/ \______/ \/').center(44)
	print (c5 +'/    /__\'').center(44)
	print ('(\   /____\'').center(44)
	print W + ' '
	print ('FUEGO LEGENDARY BOT').center(44)
	print ' '
...
def baliho():
	try:
		...
		print "(\____/)".center(44)
		print '(_oo_)'.center(44)
		print c4 + '(O)'.center(44)
		print '__||__    \)'.center(44)
		print '[]/______\[] /'.center(44)
		print '/ \______/ \/'.center(44)
		print c5 + '/    /__\''.center(44)
		print '(\   /____\''.center(44)
...
def info_ga():
  ...
  [+] full_data           fetching all friends data
  [+] info           show information about  your friend

  [+] get_id            fetching all id from friend list
  [+] get_phone         fetching all phone number from friend list
  [+] get_mail          fetching all emails from friend list
  ...
  [+] clear              clear terminal
   help               show help
   about_tool              Show information about this program
...
def menu_bot():
 ...
 ---------   ------------------------------------
   ...
   [ 05 ]      delete all posts in your time line
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'ReKuShE' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'ReKuShE' + W +'/' + R +'Bot ' + W + '>> ')
...
def main():
  ...
  try:
	cek = raw_input(R + 'Bs4 bot' + W +' >> ')

	if cek.lower() == 'full_data':
		if len(jml) == 0:
			getdata()
		else:
...
'''
		...
		info_ga()
		main()
	elif cek.lower() == 'get_id':
		get_id()
	elif cek.lower() == 'get_phone':
		get_phone()
	elif cek.lower() == 'get_mail':
		get_mail()
...
def search():
	...
	if len(jml) == 0:
                ...
                print '[!] type "full_data" to collect friends data'
                main()
        else:
                pass
